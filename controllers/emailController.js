...
const sendEmail = (req, res) => {
    const { to, subject, meetingLink,roomId, senderEmail, senderPassword } = req.body;
    ...
    const mailOptions = {
        ...
        <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F5F6F8;">
          <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #F5F6F8;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="640"
              ...
              <tr class="wp-block-editor-spacerblock-v1">
                <td style="background-color:#F5F6F8;line-height:50px;font-size:50px;width:100%;min-width:100%">&nbsp;</td>
              </tr>
              <tr class="wp-block-editor-imageblock-v1">
                <td style="background-color:#1f2532;padding-top:12px;padding-bottom:12px;padding-left:12px;padding-right:12px"
                  align="center">
                  <table align="center" width="455.84" class="imageBlockWrapper" style="width:455.84px" role="presentation">
                    <tbody>
                      <tr>
                        <td style="padding:0"><img src="https://api.smtprelay.co/userfile/c686ed62-78df-4e6a-96bf-7b706d1db82c/whiteboard-removebg-preview.png" width="455.84" height="" alt="" style="border-radius:0px;display:block;height:auto;width:100%;max-width:100%;border:0" class="g-img">
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr class="wp-block-editor-headingblock-v1">
                <td valign="top"
                  style="background-color:#ffffff;display:block;padding-top:64px;padding-right:32px;padding-bottom:32px;padding-left:32px;text-align:center">
                  <p style="font-family:Open Sans, sans-serif;text-align:center;line-height:36.80px;font-size:32px;background-color:#ffffff;color:#000000;margin:0;word-break:normal"
          ...
          <script>
            function copyRoomID() {
                const roomID = "${roomId}"; // Fetch the room ID from your template variable
